...
md:border border-gray-300/20 overflow-hidden transition-[width] duration-300 ${isOpen ?'max-md:w-full' : 'max-md:w-0'}`}>
      ...
      <div className='flex items-center gap-8'>
        ...
        <button 
          ...
          className='px-4 py-1 sm:px-7 sm:py-2 bg-[var(--color-primary)] hover:bg-[var(--color-primary-dull)] transition-colors rounded-full font-medium cursor-pointer text-white'
        >Login
        </button>
        </div>
